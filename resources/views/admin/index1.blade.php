                    ...
                    <div class="col-12 float-left nopadmar">
                        <div class="row">
                            <div class="square_box col-6 text-right">
                                ...
                                <div class="number text-success" id="myTargetElement3"></div>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="col-12 float-left nopadmar">
                        <div class="row">
                            <div class="square_box col-6 text-right">
                                ...
                                <div class="number text-warning" id="myTargetElement4"></div>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="col-12 float-left nopadmar">
                        <div class="row">
                            <div class="square_box col-6 text-right">
                                ...
                                <div class="number text-danger" id="myTargetElement1"></div>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="col-12 float-left nopadmar">
                        <div class="row">
                            <div class="square_box col-6 text-right">
                                ...
                                <div class="number text-primary" id="myTargetElement2"></div>
                            </div>
                            <div class="col-6">
