                                ...
                                <div class="form-group required">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control required" title="Select user type..." name="user_role"
                                                        id="user_role">
                                                        <option value="">Select</option>
                                                        <option value="tutor" @if($user->user_role === 'tutor')
                                                    selected="selected" @endif >tutor</option>
                                                        <option value="student" @if($user->user_role === 'student')
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control required" title="Select role..." name="account_type"
                                                        id="account_type" value="{!! old('account_type', $user->account_type) !!}">
                                                        <option value="">Select</option>
                                                        <option value="premium" @if($user->account_type === 'premium')
                                                    selected="selected" @endif >premium</option>
                                                        <option value="vip" @if($user->account_type === 'vip')
                                                    selected="selected" @endif >vip</option>
                                                </select>
