  ...
  <div class="container">
    ...
    <div class="container bg-white">
        <div class="row">
            ...
            <h1 class="p-2"> Create new password</h1>
                    ...
                    <div class="card card-body rounded">
                        <div class="d-flex flex-column">
                            <div class="p-2">
                                ...
                                <input type="email" class="form-control" name="password" placeholder="Enter a new password">
                                <small>{{ $errors->first('email', 'Enter a new password') }}</small>
                            </div>
                            <div class="p-2">
                                <label for="email">Confirm Password</label> 
                                <input type="email" class="form-control" name="password_confirm" placeholder="Confirm Password">
                                <small>{{ $errors->first('password_confirm', 'Enter a new password') }}</small>
                            </div>
                            <div class="d-flex flex-row">
                                <div class="col-lg-8 p-2 mt-3">
                                    <input type="submit" class="form-wizard-next-btn btn-block rounded" value="RESET PASSWORD">
                                </div>
                            </div>
                        </div>
                    </div>
