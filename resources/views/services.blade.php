        ...
        <div class="container pt-lg-3">
            <div class="aboutgrids row">
                <div class="col-lg-6 aboutgrid2">
                    <img src="{{asset('images/g2.jpg')}}" alt="about image" class="img-fluid" />
                </div>
                <div class="col-lg-6 aboutgrid1 my-lg-0 my-5">
                    <h4 style="text-align: center;">Having fun while learning is possible</h4>
                    ...
                    <a href="{{URL::to('contact')}}" class="btn btn-outline-secondary theme-button">Know More</a>
                </div>
            </div>
        </div>
