    ...
    <section class="w3l-contacts-12" id="contact">
        <div class="container py-5">
                        <div class="card">
                                    ...
                                    <h3><span class="fa fa-info-circle fa-4x px-3"></span>STUDPORT TERMS AND CONDITIONS</h3>
                                    </div>
                                    <div class="card-body">
                                    <h4 style="padding-bottom: 10px;"><strong>Welcome to StudPort!</strong></h4>
                                    <p>These terms and conditions outline the rules and regulations for the use of StudPort's Website, located at studport.cm.</p>
                                    <p  style="color: #AD1523;">By accessing this website we assume you accept these terms and conditions.
                                    <strong>Do not continue to use StudPort if you do not agree to take all of the terms
                                    and conditions stated on this page.</strong></p>
                                    ...
                                    Company’s stated services, in accordance with and subject to, prevailing law of Cameroon.
                                    ...
                                    referring to same. </p>
                                    <h4 style="padding: 10px;"><strong>Cookies </strong></h4>
                                    ...
                                    Most interactive websites use cookies to let us retrieve the user’s details for each visit.
                                        ...
                                        <h4 style="padding: 10px;"><strong>Licence</strong></h4>
                                        ...
                                        <p style="padding: 10px;">You warrant and represent that:</p>

                                        <ul style="color: #AD1523; padding: 10px;">
                                        ...
                                        <h4 style="padding: 10px;"><strong>Hyperlinking to our Content</strong></h4>
                                        <ul>
                                        ...
                                        <h4 style="padding: 10px;"><strong>iFrames</strong></h4>
                                        ...
                                        <h4 style="padding: 10px;"><strong>Your Privacy</strong></h4>
                                        <p>Please read Privacy Policy</p>
                                        <h4 style="padding: 10px;"><strong>Reservation of Rights</strong></h4>
                                        ...
                                        By continuously linking to our Website, you agree to be bound to and follow these linking terms
                                            and conditions.</p>
                                            <h4 style="padding: 10px;"><strong>Removal of links from our website</strong></h4>
