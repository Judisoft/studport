...
<div class="container-fluid " style="overflow-x: hidden;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="card card-body">
                                                {!! Form::open(['action' => 'UserBlogController@update', 'method' => 'put', 'class' => 'bf', 'files'=> true,])!!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group" style="font-size: 14px;">
                                                            {!! Form::text('tags',$blog->tagList, ['class' => 'form-control input-lg input-group input-group-append rounded-0',
